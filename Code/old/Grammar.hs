...
happyReduction_3 (HappyTerminal (TokenInt happy_var_3))
	_
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenSeq -> cont 13;
	TokenBackslash -> cont 14;
	TokenLambdaIs -> cont 15;
	TokenOpenList -> cont 16;
	TokenCloseList -> cont 17;
	TokenSeperator -> cont 18;
	TokenAdd -> cont 19;
	TokenAnd -> cont 20;
	TokenAss -> cont 21;
	TokenConsList -> cont 22;
	_ -> happyError' (tk:tks)
	}
